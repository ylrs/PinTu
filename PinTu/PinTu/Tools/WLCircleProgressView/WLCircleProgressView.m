...
+(instancetype)viewWithFrame:(CGRect)frame circlesSize:(CGRect)size withColor:(UIColor *)foreColor
{
    return [[self alloc] initWithFrame:frame circlesSize:size withColor:foreColor];
}
- (instancetype)initWithFrame:(CGRect)frame circlesSize:(CGRect)size withColor:(UIColor *)foreColor
{
...
-(void)addForeCircleWidthSize:(CGFloat)radius lineWidth:(CGFloat)lineWidth{
    if (self.foreCircle == nil) {
        ...
        self.foreCircle.strokeEnd = 0.0;
        if (self.foreColor) {
            self.foreCircle.strokeColor = self.foreColor.CGColor;
        }
        else{
